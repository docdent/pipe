...
#endif
// Arduino DB4->D4  DB5->D5  DB6->D6  DB7->D7  RS->D8  E->D9  (BL)->D10
// UNO     DB4->PD4 DB5->PD5 DB6->PD6 DB7->PD7 RS->PB0 E->PB1 (BL)->PB2
// MEGA    DB4->PG5 DB5->PE3 DB6->PH3 DB7->PH4 RS->PH5 E->PH6 (BL)->PB4

//  LCD_DB4-7, RS, E in hw_defs.h

#define LCD_RW_PORT              PORTH       // Port for RW line (ONLY used if RW_LINE_IMPLEMENTED=1)
