...
.L83:
	...
	rjmp .L86
.LBE45:
	.loc 1 1480 0 is_stmt 1 discriminator 2
...
.LBB50:
	...
	rjmp .L99
.LBE50:
	.loc 1 1553 0 is_stmt 1 discriminator 2
	inc r14
.LVL320:
.L97:
...
.L261:
	...
	st Z,r19
	.loc 1 1939 0 is_stmt 1 discriminator 4
	subi r18,lo8(-(1))
.LVL548:
	rjmp .L243
.LVL549:
...
.L456:
	...
	adc r19,r21
.LVL862:
	.loc 1 2419 0 is_stmt 1 discriminator 4
	movw r30,r24
	lpm r24,Z
	andi r24,lo8(63)
	cpi r24,lo8(11)
...
.L466:
	...
	breq .L467
	.loc 1 2453 0 is_stmt 1 discriminator 2
	lds r20,nibbleIndex
	cpi r20,lo8(-1)
	breq .L467
	.loc 1 2456 0
...
.L514:
	...
	ldi r25,0
.L499:
	.loc 1 2658 0 discriminator 4
	add r26,r24
	adc r27,r25
.LVL936:
	.loc 1 2659 0 is_stmt 1 discriminator 4
	movw r30,r18
	lpm r24,Z
	andi r24,lo8(63)
	cpi r24,lo8(11)
...
.L554:
	ldi r22,0
.L552:
	.loc 1 2817 0 is_stmt 0 discriminator 4
	mov r24,r28
	call keylabel_statcheck
.LVL1013:
.L551:
	.loc 1 2810 0 is_stmt 1 discriminator 2
	subi r28,lo8(-(1))
.LVL1014:
.L548:
...
.L575:
	ldi r24,lo8(9)
.L574:
	.loc 1 2877 0 is_stmt 0 discriminator 4
	call lcd_putc
.LVL1052:
