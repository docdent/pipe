...
.L77:
	...
	rjmp .L80
.LBE55:
	.loc 1 1242 0 is_stmt 1 discriminator 2
...
.L366:
	...
	adc r19,r21
.LVL606:
	.loc 1 2084 0 is_stmt 1 discriminator 4
	movw r30,r24
	lpm r24,Z
	andi r24,lo8(63)
	cpi r24,lo8(11)
...
.L376:
	...
	breq .L377
	.loc 1 2118 0 is_stmt 1 discriminator 2
	lds r20,nibbleIndex
	cpi r20,lo8(-1)
	breq .L377
	.loc 1 2121 0
...
.L424:
	...
	ldi r25,0
.L409:
	.loc 1 2323 0 discriminator 4
	add r26,r24
	adc r27,r25
.LVL680:
	.loc 1 2324 0 is_stmt 1 discriminator 4
	movw r30,r18
	lpm r24,Z
	andi r24,lo8(63)
	cpi r24,lo8(11)
...
.L510:
	ldi r22,0
.L508:
	.loc 1 2481 0 is_stmt 0 discriminator 4
	mov r24,r28
	call keylabel_statcheck
.LVL907:
.L507:
	.loc 1 2474 0 is_stmt 1 discriminator 2
	subi r28,lo8(-(1))
.LVL908:
.L504:
...
.L531:
	ldi r24,lo8(9)
.L530:
	.loc 1 2541 0 is_stmt 0 discriminator 4
	call lcd_putc
.LVL946:
	.loc 1 2542 0 is_stmt 1 discriminator 4
	mov r24,r28
	call lcd_goto
.LVL947:
/* epilogue start */
