...
const __flash SectionInfo_t sectionInfo[DISPLAY_SECTION_COUNT] = {
	{LCD_LINE0+0, 5, 0}, //#define DISPLAY_SECTION_MIDIIN 0
	{LCD_LINE0+20-5, 5, 0},// #define DISPLAY_SECTION_MIDIOUT 1
	{LCD_LINE0+10-3, 5, 0}, // #define DISPLAY_SECTION_CLOCK 2
	{LCD_LINE0+10+2, 1, 0},// #define DISPLAY_SECTION_POWER 3
	{LCD_LINE0+10+3, 1, 0},// #define DISPLAY_SECTION_ERROR 4
	{LCD_LINE1+0,20, 0},// #define DISPLAY_SECTION_MENU 5
	{LCD_LINE2+10, 10, 0},// #define DISPLAY_SECTION_MENU_DATA 6
	{LCD_LINE2+0, 10, 0},// #define DISPLAY_SECTION_MENU_EXTRA 7
	{LCD_LINE2+0, 20, 0},// #define DISPLAY_SECTION_MENU_MESSAGE 7
	{LCD_LINE1+0, 20, 0},// #define DISPLAY_SECTION_MAIN_MESSAGE 8
	{VOIDSTART, 0, 4},// #define DISPLAY_SECTION_MAIN_SOFTKEYS 9
	{LCD_LINE2+0, 7, 0},
	{LCD_LINE2+0, 7, 0},
	{LCD_LINE3+2, 7, 0},
	{LCD_LINE2+12, 7, 0},
	{LCD_LINE3+0, 20, 0},// #define DISPLAY_SECTION_MENU_SOFTKEYS 14
	{LCD_LINE3+0, 5, 0},
	{LCD_LINE3+5, 5, 0},
	{LCD_LINE3+10, 5, 0},
	{LCD_LINE3+15, 5, 0},
